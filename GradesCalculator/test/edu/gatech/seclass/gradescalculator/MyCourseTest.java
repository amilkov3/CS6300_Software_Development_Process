...
/**
 * Created by ammilkov on 7/17/15.
 */
public class MyCourseTest {
    ...
    public void testAddStudent(){
        Student student1 = new Student("Alex Milkov", "902797315", course);
    ...
    public void testAddGradesForProject(){
        ...
        assertEquals(83, course.getAverageProjectsGrade(student2));
        assertEquals(94, course.getAverageProjectsGrade(student3));
    }
